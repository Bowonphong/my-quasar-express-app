...
// จากตัวอย่างก่อน
const gitSteps = [
  { title: 'Create Feature Branch', detail: 'git checkout -b feature/new-feature' },
  { title: 'Commit Changes', detail: 'git commit -m "Add new feature"' },
  { title: 'Push to Remote', detail: 'git push origin feature/new-feature' },
  { title: 'Create Pull Request', detail: 'Open PR on GitHub/GitLab' }
];
const dockerItems = [
  { title: 'Containerization', detail: 'Package app with dependencies' },
  { title: 'Images', detail: 'Read-only templates for containers' },
  { title: 'Docker Compose', detail: 'Define and run multi-container apps' },
  { title: 'Volumes', detail: 'Persist data generated by containers' }
];
